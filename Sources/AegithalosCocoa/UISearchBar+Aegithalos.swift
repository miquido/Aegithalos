  ...
  extension Mutation where Subject: UISearchBar {
    ...
    @inlinable public static func searchFieldBackgroundImage(
      named imageName: ImageNameConstant,
      from bundle: Bundle? = nil,
      compatibleWith traitCollection: UITraitCollection? = nil,
    ...
    @inlinable public static func iconPositionAdjustment(
      _ offset: UIOffset,
