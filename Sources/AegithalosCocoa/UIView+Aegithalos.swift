  ...
  extension Mutation where Subject: UIView {

    @inlinable public static func cornerRadius(
      _ radius: CGFloat,
    ...
    @inlinable public static func shadow(
      color: UIColor = .black,
      opacity: Float = 0.25,
    ...
    @inlinable public static func border(
      width: CGFloat,
      color: UIColor
    ) -> Self {
      Self { (subject: Subject) in
    ...
    @inlinable public static func backgroundColor(_ value: UIColor?) -> Self {
      Self { (subject: Subject) in
    ...
    @inlinable public static func clipsToBounds(_ value: Bool) -> Self {
      Self { (subject: Subject) in
        subject.clipsToBounds = value
      }
    }

    @inlinable public static func hidden(_ value: Bool) -> Self {
      Self { (subject: Subject) in
        subject.isHidden = value
      }
    }

    @inlinable public static func alpha(_ value: CGFloat) -> Self {
      Self { (subject: Subject) in
        subject.alpha = value
      }
    }

    @inlinable public static func userInteractionEnabled(_ value: Bool) -> Self {
      Self { (subject: Subject) in
        subject.isUserInteractionEnabled = value
      }
    }

    @inlinable public static func transform(_ value: CGAffineTransform) -> Self {
      Self { (subject: Subject) in
        subject.transform = value
      }
    }

    @inlinable public static func contentMode(_ value: UIView.ContentMode) -> Self {
      Self { (subject: Subject) in
        subject.contentMode = value
      }
    }

    @inlinable public static func translatesAutoresizingMaskIntoConstraints(_ value: Bool) -> Self {
      Self { (subject: Subject) in
        subject.translatesAutoresizingMaskIntoConstraints = value
      }
    }

    @inlinable public static func subview(
      _ views: UIView...
    ) -> Self {
      Self { (subject: Subject) in
        for view in views {
    ...
    @inlinable public static func topAnchor(
      ...
      Self { (subject: Subject) in
        ...
        case .greaterThanOrEqualTo:
          constraint = subject.topAnchor.constraint(
            greaterThanOrEqualTo: anchor, constant: constant)
        }
    ...
    @inlinable public static func bottomAnchor(
      _ relation: LayoutConstraintRelation,
      _ anchor: NSLayoutAnchor<NSLayoutYAxisAnchor>,
      constant: CGFloat = 0,
      priority: UILayoutPriority = .required,
      ...
      Self { (subject: Subject) in
        ...
        case .lessThanOrEqualTo:
          constraint = subject.bottomAnchor.constraint(
            lessThanOrEqualTo: anchor, constant: constant)
        case .greaterThanOrEqualTo:
          constraint = subject.bottomAnchor.constraint(
            greaterThanOrEqualTo: anchor, constant: constant)
        }
    ...
    @inlinable public static func centerYAnchor(
      _ relation: LayoutConstraintRelation,
      _ anchor: NSLayoutAnchor<NSLayoutYAxisAnchor>,
      constant: CGFloat = 0,
      priority: UILayoutPriority = .required,
      ...
      Self { (subject: Subject) in
        ...
        case .lessThanOrEqualTo:
          constraint = subject.centerYAnchor.constraint(
            lessThanOrEqualTo: anchor, constant: constant)
        case .greaterThanOrEqualTo:
          constraint = subject.centerYAnchor.constraint(
            greaterThanOrEqualTo: anchor, constant: constant)
    ...
    @inlinable public static func leftAnchor(
      _ relation: LayoutConstraintRelation,
      ...
      Self { (subject: Subject) in
        ...
        case .greaterThanOrEqualTo:
          constraint = subject.leftAnchor.constraint(
            greaterThanOrEqualTo: anchor, constant: constant)
        }
        constraint.priority = priority
        constraint.isActive = true
    ...
    @inlinable public static func leadingAnchor(
      _ relation: LayoutConstraintRelation,
      _ anchor: NSLayoutAnchor<NSLayoutXAxisAnchor>,
      constant: CGFloat = 0,
      priority: UILayoutPriority = .required,
      ...
      Self { (subject: Subject) in
        ...
        case .lessThanOrEqualTo:
          constraint = subject.leadingAnchor.constraint(
            lessThanOrEqualTo: anchor, constant: constant)
        case .greaterThanOrEqualTo:
          constraint = subject.leadingAnchor.constraint(
            greaterThanOrEqualTo: anchor, constant: constant)
    ...
    @inlinable public static func rightAnchor(
      _ relation: LayoutConstraintRelation,
      _ anchor: NSLayoutAnchor<NSLayoutXAxisAnchor>,
      constant: CGFloat = 0,
      priority: UILayoutPriority = .required,
      ...
      Self { (subject: Subject) in
        ...
        case .greaterThanOrEqualTo:
          constraint = subject.rightAnchor.constraint(
            greaterThanOrEqualTo: anchor, constant: constant)
        }
        constraint.priority = priority
        constraint.isActive = true
    ...
    @inlinable public static func trailingAnchor(
      _ relation: LayoutConstraintRelation,
      _ anchor: NSLayoutAnchor<NSLayoutXAxisAnchor>,
      constant: CGFloat = 0,
      priority: UILayoutPriority = .required,
      ...
      Self { (subject: Subject) in
        ...
        case .lessThanOrEqualTo:
          constraint = subject.trailingAnchor.constraint(
            lessThanOrEqualTo: anchor, constant: constant)
        case .greaterThanOrEqualTo:
          constraint = subject.trailingAnchor.constraint(
            greaterThanOrEqualTo: anchor, constant: constant)
    ...
    @inlinable public static func centerXAnchor(
      _ relation: LayoutConstraintRelation,
      _ anchor: NSLayoutAnchor<NSLayoutXAxisAnchor>,
      constant: CGFloat = 0,
      priority: UILayoutPriority = .required,
      ...
      Self { (subject: Subject) in
        ...
        case .lessThanOrEqualTo:
          constraint = subject.centerXAnchor.constraint(
            lessThanOrEqualTo: anchor, constant: constant)
        case .greaterThanOrEqualTo:
          constraint = subject.centerXAnchor.constraint(
            greaterThanOrEqualTo: anchor, constant: constant)
    ...
    @inlinable public static func widthAnchor(
      _ relation: LayoutConstraintRelation,
      constant: CGFloat,
      priority: UILayoutPriority = .required,
      identifier: String? = nil,
    ...
    @inlinable public static func heightAnchor(
      _ relation: LayoutConstraintRelation,
      constant: CGFloat,
      priority: UILayoutPriority = .required,
      identifier: String? = nil,
    ...
    @inlinable public static func widthAnchor(
      ...
      Self { (subject: Subject) in
        ...
        switch relation {
        case .equalTo:
          constraint = subject.widthAnchor.constraint(
            equalTo: anchor, multiplier: multiplier, constant: constant)
        case .lessThanOrEqualTo:
          constraint = subject.widthAnchor.constraint(
            lessThanOrEqualTo: anchor, multiplier: multiplier, constant: constant)
        case .greaterThanOrEqualTo:
          constraint = subject.widthAnchor.constraint(
            greaterThanOrEqualTo: anchor, multiplier: multiplier, constant: constant)
        }
        constraint.priority = priority
        constraint.isActive = true
        constraint.identifier = identifier
    ...
    @inlinable public static func heightAnchor(
      ...
      Self { (subject: Subject) in
        ...
        switch relation {
        case .equalTo:
          constraint = subject.heightAnchor.constraint(
            equalTo: anchor, multiplier: multiplier, constant: constant)
        case .lessThanOrEqualTo:
          constraint = subject.heightAnchor.constraint(
            lessThanOrEqualTo: anchor, multiplier: multiplier, constant: constant)
    ...
    @inlinable public static func edges(
      ...
      Self { (subject: Subject) in
        ...
        if usingSafeArea {
          constraints = [
            subject.topAnchor.constraint(
              equalTo: other.safeAreaLayoutGuide.topAnchor, constant: -insets.top),
            subject.leftAnchor.constraint(
              equalTo: other.safeAreaLayoutGuide.leftAnchor, constant: -insets.left),
            subject.rightAnchor.constraint(
              equalTo: other.safeAreaLayoutGuide.rightAnchor, constant: insets.right),
            subject.bottomAnchor.constraint(
              equalTo: other.safeAreaLayoutGuide.bottomAnchor, constant: insets.bottom),
          ]
        } else {
          constraints = [
    ...
    @inlinable public static func contentHugging(
    ...
    @inlinable public static func contentCompressionResistance(
      _ axis: NSLayoutConstraint.Axis,
      priority: UILayoutPriority
    ) -> Self {
      Self { (subject: Subject) in
    ...
    @inlinable public static func gestureRecognizer(
    ...
    @inlinable public static func tapGesture(
      ...
      .custom { [unowned delegate] (subject: Subject) in
        ...
        let closureHolder = ClosureHolder({ [unowned gestureRecognizer] _ in
          closure(gestureRecognizer)
        })
    ...
    @inlinable public static func swipeGesture(
    ...
    @inlinable public static func panGesture(
    ...
    @inlinable public static func pinchGesture(
      cancelsTouchesInView: Bool = false,
      delaysTouchesBegan: Bool = false,
      delaysTouchesEnded: Bool = true,
      requireToFail requiredToFail: [UIGestureRecognizer] = [],
    ...
    @inlinable public static func screenEdgePanGesture(
      edges: UIRectEdge,
      cancelsTouchesInView: Bool = false,
      delaysTouchesBegan: Bool = false,
      delaysTouchesEnded: Bool = true,
    ...
    @inlinable public static func longPressGesture(
      requiredTaps: Int = 0,
      requiredTouches: Int = 1,
