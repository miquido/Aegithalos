...
extension Mutation {
  ...
  @inline(__always) public func apply(
    on subject: inout Subject
  ) {
    Swift.assert(
      !(Subject.self is AnyObject.Type), "Reference types are not supported by this method")
    mutation(&subject)
  }
  ...
  /// - warning: This method is not suitable for reference types.
  @inline(__always) public func applied(
    on subject: Subject
  ) -> Subject {
    Swift.assert(
      !(Subject.self is AnyObject.Type), "Reference types are not supported by this method")
  ...
  @inlinable public func contramap<OtherSubject>(
  ...
  @inlinable public func contramapOptional() -> Mutation<Subject?> {
    Mutation<Subject?> { optionalSubject in
  ...
  /// Empty mutation.
  @inline(__always) public static var none: Self { Self { _ in } }
  ...
  @inline(__always) public static func custom(
    _ mutation: @escaping (inout Subject) -> Void
  ) -> Mutation<Subject> {
    Swift.assert(
      !(Subject.self is AnyObject.Type), "Reference types are not supported by this method")
  ...
  @inlinable public static func combined(
  ...
  @inline(__always) public static func set<Value>(
  ...
  @inlinable public static func when(
    _ condition: Bool,
  ...
  /// - returns: New instance of `Mutation` with conditional application.
  @inlinable public static func whenSome<Value>(
    _ optional: Value?,
  ...
  @inlinable public static func with<Variable>(
  ...
  @inlinable public static func forEach<ElementCollection: Collection>(
...
extension Mutation where Subject: AnyObject {
...
@inline(__always) public func mut<Subject>(
  ...
  Swift.assert(
    !(Subject.self is AnyObject.Type), "Reference types are not supported by this function")
...
extension Mutation where Subject: EmptyInstantiable {
  ...
  @inlinable @discardableResult public func instantiate() -> Subject {
    var subject = Subject()
    self.mutation(&subject)
    return subject
  }
...
extension Mutation {
  ...
  @inlinable public static func assert(
  ...
  extension Mutation {
    ...
    /// - note: Assertions are applied only in debug builds. It has no effect on release builds.
    @inlinable public static func dispatchPrecondition(
